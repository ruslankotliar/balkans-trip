...
export const QUICK_TIPS: TipSection[] = [
  {
    ...
    tips: [
      ...
      'BOOK Tara rafting D7 Jun 22 (Mon) — office@raftingtara.com or +381 64 420 1956 (Drina-Tara, €60pp) OR info@tarasportrafting.com / +387 66 606 306 (TaraSport, €50pp). 4 adults, Brštanovica→Šćepan Polje, ~11:30 launch.',
      'BOOK Biokovo Skywalk D2 Jun 17 ~06:30 slot — shop.pp-biokovo.hr. 20-car/hour cap, sells out. 4 × €15 = €60.',
      'BOOK Camping Kate Mlini (D12, Jun 27) — info@campingkate.com. ~€51/night for 4 + tent, 10 min from DBV airport.',
      'BOOK Autokamp Mungos (Babino Polje, Mljet — D3 Jun 18 night) — fills on June nights. NP side of the island.',
      'Book Cetina Extreme Canyoning D2 Jun 17 AM (1–2 days ahead) — canyoning-cetina.com (~€70pp) or maldukadventures.com.',
      'CHECK Kotor cruise schedule for Jun 27 at cruisetimetables.com — if many ships are in, climb San Giovanni fortress before 08:00.',
      'MLJET ferry D3 (Jun 18 Thu): the airport pickup (~17:20) leaves only the 20:30 LAST Prapratno→Sobra sailing — be rolling from the airport by ~17:45, queue Prapratno ≥45 min early. Miss it = no roof on Mljet that night (have a mainland Plan B).',
      'CALL Konoba Feral Brijesta on Jun 16–17 for D3 Jun 18 lunch (+385 98 924 6025) — family-run on south Pelješac, phone-only reservation.',
    ],
    links: [
  ...
  },
  {
    ...
    tips: [
      ...
      'ME→HR on Jun 27 (Sat, peak): use VITALJINA/Kobila (15 km south of Kotor toward Herceg Novi, cars-only, 24/7) — 10–45 min. Avoid Debeli Brijeg (1–4 h Saturday queues). Cross EARLY (before ~08:00) if you can; check the fanfani.me live camera before setting off (Vitaljina occasionally closes without notice — then fall back to Debeli Brijeg).',
      'EES (new EU biometric entry/exit): EU/EEA citizens are EXEMPT — use the EU/EEA lane, no fingerprint/face scan. NON-EU passport holders DO get enrolled at the first EU entry (here, HR) and should expect +30–90 min at the first HR→BA crossing (D4). Confirm everyone’s nationality before you go.',
    ],
    links: [
  ...
  },
  {
    title: 'Fuel & tunnels',
    tips: [
      'Fuel pricing depends on type (confirm petrol vs diesel at pickup): PETROL is cheapest in BOSNIA — tank up there. DIESEL is DEAREST in Bosnia — for a diesel car, fill in Montenegro/Croatia instead. HR petrol is the priciest.',
  ...
  },
  {
    ...
    tips: [
      ...
      'ME best ATMs: Ziraat Bank — no fee, BUT Ziraat is MASTERCARD-only; Visa cards are declined. Visa holders: use a bank ATM and decline DCC. Always choose "local currency" — never "home currency" (DCC rip-off).',
      'Get BAM only in Bosnia (a Mostar Raiffeisen, no fee) and spend it down before crossing into Montenegro — KM is hard to exchange back. Many rural campsites, konobas, and small operators (Kravica, Durmitor/Ostrog gates) are CASH-only. Keep €100–150 in small bills at all times.',
