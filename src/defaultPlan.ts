...
export const DEFAULT_PLAN: Overrides = {
  ...
  'hr-cetina-canyoning':     { day: 2, dayOrder: 1 },
  'hr-camp-lisicina':        { day: 2, dayOrder: 2 },
  ...
  'hr-dubrovnik-airport-pickup': { day: 3, dayOrder: 7 },
  'hr-camping-kate-mlini':   { day: 3, dayOrder: 8 },

  // ── Day 4: Jun 19 (Fri) — Dubrovnik ─────────────────────────────────────
  'hr-dubrovnik':            { day: 4, dayOrder: 1 },
  'hr-dubrovnik-sea-kayak':  { day: 4, dayOrder: 2 },
  'hr-camp-prapratno':       { day: 4, dayOrder: 3 },

  // ── Day 5: Jun 20 (Sat) — Mljet ─────────────────────────────────────────
  'hr-prapratno-ferry':      { day: 5, dayOrder: 1 },
  ...
  // ── Day 6: Jun 21 (Sun) — Kravica → Počitelj → Mostar ───────────────────
  'ba-kravica':              { day: 6, dayOrder: 1 },
  'ba-pocitelj':             { day: 6, dayOrder: 2 },
  'ba-mostar':               { day: 6, dayOrder: 3 },
  'ba-cafe-de-alma-mostar':  { day: 6, dayOrder: 4 },
  'ba-tima-irma':            { day: 6, dayOrder: 5 },
  'ba-gem-mostar-nanas-house': { day: 6, dayOrder: 6 },
  // ba-daorson removed: Illyrian hillfurt on an unmarked dirt road 20km S of
  // Mostar — too much detour for an already full Day 6.

  // ── Day 7: Jun 22 (Mon) — Mostar → Sarajevo ─────────────────────────────
  'ba-blagaj':               { day: 7, dayOrder: 1 },
  'ba-boracko-lake':         { day: 7, dayOrder: 2 },
  'ba-sarajevo':             { day: 7, dayOrder: 3 },
  'ba-zuta-tabija':          { day: 7, dayOrder: 4 },
  'ba-sarajevo-petica-ferhatovic': { day: 7, dayOrder: 5 },
  'ba-cinemas-sloga-latin-night': { day: 7, dayOrder: 6 },
  'ba-air-1542024184506963047': { day: 7, dayOrder: 7 },
  // ba-lukomir removed: full-day 4WD excursion, cannot fit on an already
  // packed Day 7 with Blagaj + Boračko Lake + Sarajevo.

  // ── Day 8: Jun 23 (Tue) — Sarajevo → Tara rafting → Žabljak ─────────────
  'me-tara-rafting-brstanovica': { day: 8, dayOrder: 1 },
  'me-scepan-polje-piva-canyon': { day: 8, dayOrder: 2 },
  'me-mratinje-dam':         { day: 8, dayOrder: 3 },
  ...
  'me-vrazje-jezero':        { day: 9, dayOrder: 2 },
  ...
  'me-camp-safari-beach':    { day: 11, dayOrder: 5 },
  ...
  'me-tanjga-kotor':         { day: 12, dayOrder: 5 },
  'me-perast':               { day: 12, dayOrder: 6 },
  // me-lustica-blue-cave removed: no time on a day already holding Sveti Stefan
  // + Kotor fortress + Perast + Trebinje border run.
